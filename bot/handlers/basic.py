...
async def bot_help(message: Message):
    ...
    await message.answer('Список доступных команд:\n'
                         ...
                         '/buy_tokens - Покупка токенов. Для покупки необходимо добавить свою почту.'
                         'Для этого просто напишите в чат свою почту.'
                         'Выберите колличество токенов, которое хотите купить,'
                         'после этого будет сформирована ссылка с оплатой и кнопка "проверить оплату".'
                         'Нужно перейти по ссылке и оплатить. После этого нажать кнопку "проверить оплату".'
                         'Токены будут зачислены на ваш счет\n\n'
